...
class Topic extends dbLink
{
    ...
    public function nextCategoryID($category_name){ //Función para obtener el siguiente ID que se utilizará para crear una categoría que existe o no existe.
    ...
    public function getTopicStatus($id_topic, $status){ //Función que devuelve un booleano dependiendo del estado de una publicación.
