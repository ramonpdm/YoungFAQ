                  ...
                  <div class="wrap-bt">
                      <div class="posted">
                          ...
                          <span class="time flex-m">
                              ...
                              <span><?= App\Core\Functions\getAgo($topic->getCreatedAt()); ?></span>
                          </span>
                      </div>
                      ...
                      <div class="col-sm-12">
                          <div class="wrap-bt">
                              <div class="posted">
                                  <div class="avatar">
                                      <img src="/YoungFAQ/public/images/avatar.png" alt="Profile pic" class="d-none d-xs-none d-sm-none d-lg-block">
                                      <?= App\Helpers\UserPresentation::username($comment->getAuthor()); ?>
                                  </div>
                                  <span class="time flex-m">
                                      <i class="fa fa-clock-o"></i>
                                      <span><?= App\Core\Functions\getAgo($comment->getCreatedAt()); ?></span>
                                  </span>
                              </div>
                          </div>
                      </div>
  ...
  <?php else : ?>
      <div class="post">
          <div class="wrap-ut not-found">
              <div class="posttext">
                  <h2>Esta publicación no posee comentarios</h2>
              </div>
              <div class="right">
                  <?php if (App\Models\User::isLogged()) : ?>
                      <button class="btn btn-primary" data-toggle="collapse" data-target="#newtopicWrap">Comentar</button>
                  <?php endif ?>
              </div>
          </div>
      </div>
